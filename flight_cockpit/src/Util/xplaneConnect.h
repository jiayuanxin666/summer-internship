...
typedef enum {
    XPC_ERROR_NONE = 0, XPC_ERROR_WSA_STARTUP, XPC_ERROR_SOCKET_CREATE,
    ...
    XPC_ERROR_RESPONSE_HEADER, XPC_ERROR_RESPONSE_LENGTH, XPC_ERROR_DREF_COUNT
} XPCError;
...
void XPC_EnableRxTraceOnce(void);
